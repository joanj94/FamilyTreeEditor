 ...
 *
 * Four kinds of message, and each is announced rather than merely drawn. They appear in response
 ...
 *
 * `alert` for the two failures, because a file that would not open or a tree that could not be
 * stored interrupts what the user was doing. `status` for the rest, which are the results of what
...
export function Notices({ failed, storeFailure, refused, saved }: NoticesProps) {
  return (
    <>
      {failed === null ? null : (
